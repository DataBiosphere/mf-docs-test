package bio.terra.mfdoctest.api;
...
import bio.terra.mfdoctest.config.VersionConfiguration;
import bio.terra.mfdoctest.controller.PublicApiController;
import bio.terra.mfdoctest.model.SystemStatus;
import bio.terra.mfdoctest.service.StatusService;
...
class PublicApiControllerTest {
  ...
  void testVersion() throws Exception {
    ...
    String github = "https://github.com/DataBiosphere/mf-docs-test/tree/0.9.0";
    String build = "0.1.0";
