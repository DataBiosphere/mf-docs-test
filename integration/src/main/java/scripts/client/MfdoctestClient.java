...
import bio.terra.mfdoctest.client.ApiClient;
...
public class MfdoctestClient extends ApiClient {
   ...
   */
  public MfdoctestClient(ServerSpecification server) throws IOException {
    this(server, null);
  }
   ...
   */
  public MfdoctestClient(ServerSpecification server, TestUserSpecification testUser)
      throws IOException {
